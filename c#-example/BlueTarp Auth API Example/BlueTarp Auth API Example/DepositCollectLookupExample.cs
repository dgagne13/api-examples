...
{
    class DepositCollectLookupExample : ExampleBase
    {
        public static void Run()
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(BLUETARP_TEST_API + BLUETARP_TEST_MERCHANT + "/transactions/deposit");
