...
{
    class RetrieveCreditDataExample : ExampleBase
    {
        public static void Run()
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(BLUETARP_TEST_API + BLUETARP_TEST_MERCHANT + "/customers?bluetarp-cid=" + BLUETARP_TEST_CID);
